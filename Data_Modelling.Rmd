...
load("~/Documents/Masters/Dissertation/Project_Git/Data/data_11.RData")  # All Data 2011-2012
...
I still have both full data sets for both years (2015-2016 and 2009-2010) but for the 2015-2016 data set there are 5474 observations (with 1453 missing values) and for the 2009-2010 data set there are 6059 observations (with 1371 missing values). When I remove the 'Don't Know' responses, there are 45 missing values in the 2015-2016 data set and there are 42 missing values in the 2009-2010 data set.

In my Reduced Data Sets:

+ Removing Don't Know responses
+ Removing NA values
+ Removing Refused response (only 2) from smoking variable (2015-2016 Reduced Data)
