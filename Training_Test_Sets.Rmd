...
mean(pred3a != Train$Hypertension)*100 # training error
# Test error
pred3b <- predict(f3, Test)
mean(pred3b != Test$Hypertension)*100
...
tab1<- table(predict(f4, Train, type="class"), Train$Hypertension)
tab1
...
tab1 <-table(predict(f4, Test,type="class"), Test$Hypertension)
tab1
...
#ROC RandomForest
require(pROC)
rf.roc<-roc(Train$Hypertension,f3$votes[,2])
plot(rf.roc)
auc(rf.roc)
