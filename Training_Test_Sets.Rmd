...
require(pROC)
rf.roc<-roc(Train$Hypertension,f1$votes[,2])
plot(rf.roc, title = "Random Forest ROC")
auc(rf.roc)
...
#NN
invisible(plot(roc(factor(Train$Hypertension), fitted(f2)), print.thres = c(.1, .5), col = "red", print.auc = T))

#Log1
invisible(plot(roc(factor(Train$Hypertension), fitted(f3)), print.thres = c(.1, .5), col = "red", print.auc = T))

#Log2
invisible(plot(roc(factor(Train$Hypertension), fitted(f4)), print.thres = c(.1, .5), col = "red", print.auc = T))
