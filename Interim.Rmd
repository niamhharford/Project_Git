...
## 2.3 Data Exploration{#explor}


```{r, figures-side, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE , fig.height=3, fig.show='hold', fig.cap="Boxplot displaying the effect of Age and BMI on hypertension.\\label{fig:age_bmi"}
...
```{r, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.height=3, fig.cap="Bar chart displaying the effect of Smoking and Kidney disease on hypertension.\\label{fig:smoke_diabetes}",fig.show='hold'}
a<- ggplot(data_11a) +
...
b<- ggplot(data_11a) +
      geom_bar(aes(x = KidneyF, fill = Hypertension),position = "dodge") + facet_wrap(~Gender) + labs(x="Kidney Disease") + labs(fill="Hypertension")
...
```{r, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE,fig.height=3, fig.cap="Bar chart displaying the effect of Diabetes and Physical activity on hypertension.\\label{fig:diabetes_pact}",fig.show='hold'}
a<- ggplot(data_11a) +
...
```{r, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE,fig.height=3, fig.cap="Bar chart displaying the effect of Alcohol and Salt use on hypertension.\\label{fig:alco_salt}",fig.show='hold'}
a<- ggplot(data_11a) +
...
```{r, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE,fig.height=5, fig.cap="Boxplot displaying the effect of Potassium and Race on hypertension.\\label{fig:pot_race}",fig.show='hold'}
a<- ggplot(data_11a) +
