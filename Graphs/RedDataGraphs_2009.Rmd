---
title: "Reduced Data 2009/2010 -Graphs"
...
```{r, eval=TRUE}
load("~/Documents/Masters/Dissertation/Project_Git/Data/data3_09_10.RData") 
library(ggplot2)
```
...
ggplot(data3) + geom_boxplot(aes(x= Age, y = Hypertension)) + facet_wrap(~Gender) + labs(x="Age", y = "Hypertension") + coord_flip()
