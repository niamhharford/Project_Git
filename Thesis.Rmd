...
# Test Errors
# Logistic Regression
predicted <- predict(model_log1, Test, type="response")
predicted <- factor(ifelse(predicted < .5, 0,1))
tab1 <- table(Test$Hypertension, predicted)
tab1
...
# Test error
predicted <- predict(model_rf, Test, type = "class")
tab2 <- table(Test$Hypertension, predicted)
...
predicted <- factor(ifelse(predict(model_nn, Test, type ="raw") > 0.5,1,0))
tab3 <- table(Test$Hypertension, predicted)
tab3
