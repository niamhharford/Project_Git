...
The neural network model required further tuning using tidymodels, as its fit was not satisfactory. The model fit was updated specifying tune() for the the hidden_units, penalty and epochs. A grid was created using the grid_regular() function and the range for tuning for each argument was specified. A range from 0 to 20 was defined for the hidden_units, 0.5 to 0.0000001 for the penalty and 10 to 10000 for the epochs. The best model was chosen based of the best "roc_auc" value. The final neural network model contained 20 hidden units, a penalty of	1.77828 and 5005 epochs.
