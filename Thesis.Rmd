...
```{r, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE,fig.height=2, fig.width=2,  fig.cap="Logistic regression confusion matrix\\label{fig:cf1}",fig.show='hold'}
...
```{r, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE,fig.height=2, fig.width=2, fig.cap="Random forest confusion matrix.\\label{fig:cf2}",fig.show='hold'}
...
```{r, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.height=2, fig.width=2,fig.cap="Neural Network confusion matrix\\label{fig:cf3}",fig.show='hold'}
