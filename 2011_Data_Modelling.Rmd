...
data <- source_url('https://github.com/niamhharford/Project_Git/blob/master/data1_11a.RData')
```
...
set.seed(1)
model_nn <- nnet(Hypertension ~ ., data=data_11a, size=14)
model_nn
